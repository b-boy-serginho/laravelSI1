                        ...
                        <form action="{{ url('/crear_producto') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="number" name="costoCompra" min="0" id="costoCompra"
                                        class="form-control">
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="number" name="precioVenta" min="0" id="precioVenta" required
                                        class="form-control">
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="precioDescuento" class="font-weight-medium">Precio de Descuento</label>
                                    <input type="number" name="precioDescuento" min="0" id="precioDescuento"
                                        class="form-control">
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="file" name="imagen_url" id="imagen_url" required
                                        class="form-control">
                                </div>
                            </div>
                ...
                <tbody>
                    @foreach ($producto as $productos)
                        <tr>
                            ...
                            <td>
                                <a href="{{ url('editar_producto', $productos->id) }}"
                                    class="btn btn-link text-primary">Editar</a>
                                <a href="{{ url('borrar_producto', $productos->id) }}" class="btn btn-link text-danger"
