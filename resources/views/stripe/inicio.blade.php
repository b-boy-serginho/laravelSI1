        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-default credit-card-box">
                ...
                <div class="panel-body">
                    ...
                    <form 
                            role="form" 
                            action=" {{ route('stripe.post', $totalAPagar) }} "
                            method="post" 
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <button class="btn btn-primary btn-lg btn-block" type="submit">Pagar {{$totalAPagar}} Bs</button>
                                <br>
                                <a href="{{url('/ver_carrito')}}" class=" btn btn-warning btn-lg btn-block" 
                                   >volver</a>
                            </div>
                        </div>
